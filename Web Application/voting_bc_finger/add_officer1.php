...
$mq=mysqli_query($connect,"select max(id) from vt_officer1");
...
$qry=mysqli_query($connect,"insert into vt_officer1(id,state,name,contact,email,uname,pass) values($id,'$state','$name','$contact','$email','$uname','$pass')");

$message="Returning Officer: Username:$uname, Password:$pass";
echo '<iframe src="http://iotcloud.co.in/testmail/sendmail.php?message='.$message.'&email='.$email.'" style="display:none"></iframe>';
if($qry)
{
?>
	<script language="javascript">
	window.location.href="add_officer1.php";
	</script>
	<?php
	}
...
if($act=="del")
{
mysqli_query($connect,"delete from vt_officer1 where id=$did");
?>
	<script language="javascript">
	window.location.href="add_officer1.php";
	</script>
		   ...
		   <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						<?php
						$qry=mysqli_query($connect,"select * from vt_officer1");
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
											...
											<td><?php echo '<a href="add_officer1.php?act=del&did='.$row['id'].'">Delete</a>'; ?></td>
                                        </tr>
                                     	<?php
										}
										?>
