			...
			<div class="col-sm-8 col-xs-12">  
			 ...
			 <div class="panel-body">
			  <table width="70%" border="0" cellpadding="5" cellspacing="5">
                  <tr>
                    <th width="20%" valign="top">Voter ID </th>
                    <td width="24%" valign="top">: <?php echo $r1['voterid']; ?></td>
                    <th width="21%" valign="top">Aadhar No. </th>
                    <td width="35%" valign="top">: <?php echo $r1['aadhar']; ?></td>
                  </tr>
                  <tr>
                    <th valign="top">Name</th>
                    <td valign="top">: <?php echo $r1['name']; ?></td>
                    <th valign="top">Division</th>
                    <td valign="top">: <?php echo $r1['division']; ?></td>
                  </tr>
                  <tr>
                    <th valign="top">Date of Birth </th>
                    <td valign="top">: <?php echo $r1['dob']; ?></td>
                    <th valign="top">District</th>
                    <td valign="top">: <?php echo $r1['city']; ?></td>
                  </tr>
                  <tr>
                    <th valign="top">Gender	</th>
                    <td valign="top">: <?php echo $r1['gender']; ?></td>
                    <th valign="top">&nbsp;</th>
                    <td rowspan="2" valign="top"><img src="images/Q<?php echo $r1['id']; ?>.png" width="150" height="150"></td>
                  </tr>
                  <tr>
                    <th valign="top">Address	</th>
                    <td valign="top">: <?php echo $r1['address'].", ".$r1['area']; ?></td>
                    <th valign="top">&nbsp;</th>
                  </tr>
                </table>
			   </div>
