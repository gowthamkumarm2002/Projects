...
$q2=mysqli_query($connect,"select * from vt_booth where uname='$booth'");
$r2=mysqli_fetch_array($q2);
if($r2['status']=="2")
{
mysqli_query($connect,"update vt_booth set status=0 where uname='$booth'");
?>
                        ...
                        <div class="col-sm-6 col-xs-12">  
                            <div class="panel panel-default chartJs">
                                <div class="panel-heading">
									...
									if($r1['status']=="1")
										{
										mysqli_query($connect,"update vt_voter set status=2 where id=$id");
										?>
										 <div class="title" style="color:#009900">Vote Registered...</div>
										<?php
										}
										else if($r1['status']=="2")
										{
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="panel panel-default chartJs">
                                ...
                                <div class="panel-body" align="center">
                                    <img src="assets/img/vvv.jpg" class="img-responsive" width="380" height="380">
